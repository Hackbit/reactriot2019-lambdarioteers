  ...
  tasks: [
    {
      ...
      pointsToEarn: 25,
      description:
        'Gathering any and all supplies to help support the less fortunate students during the back-to-school season.',
      img:
    ...
    },
    {
      ...
      pointsToEarn: 35,
      description:
        'Spending the afternoon in Nashville, delivering food to the homeless individuals around town from 12:00pm to 4:00pm!',
      img:
    ...
    },
    {
      ...
      pointsToEarn: 50,
      description:
        'Gathering the city of Portland to create individual meals for the elderly and disabled individuals in town. All day long!',
      img:
        'https://images.unsplash.com/photo-1562166351-8547c7362981?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1934&q=80'
    }
  ],
  isUpdating: false,
  id: '',
